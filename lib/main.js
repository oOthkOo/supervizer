...
function startAll( app ) {
	...
	for (var a=0; a<apps.length; a++) {
		var result = start( apps[a] );
		if ( !isSuccess( result )) {
			return result;
		}		
	}
	
	return getSucess( null, apps.length + ' apps succesfully started.' );
}
...
function stopAll( app ) {
	...
	for (var a=0; a<apps.length; a++) {
		var result = stop( apps[a] );
		if ( !isSuccess( result )) {
			return result;
		}		
	}
	
	return getSucess( null, apps.length + ' apps succesfully stopped.' );
}
...
function restartAll( app ) {
	...
	return getSucess( null, apps.length + ' apps succesfully restarted.' );
}
