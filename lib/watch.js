...
function watch (fpath, options, cb) {
    ...
    if (is.file(fpath)) {
        ...
        watcher = fs.watch(parent, options, function (evt, fname) {
        ...
        watcher = fs.watch(fpath, options, function (evt, fname) {
            if (fname) {
